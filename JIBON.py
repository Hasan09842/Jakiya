...
while attemps < 12345677901:
    ...
    if username == 'HASAN' and password == 'TASNIM':
        ...
        continue
os.system('clear')
os.system('xdg-open fb profile://https://www.facebook.com/profile.php?id=100087567123370')
#....................WELCOME MY TOOL....................#
def logo():
	print("""%s\033[0;37m .%%..%%...%%%%....%%%%....%%%%...%%..%%.
             \033[1;92m .%%..%%..%%..%%..%%......%%..%%..%%%.%%.
             ...
             \033[1;93m▇▇➣    \033[1;94mGIVE ME 450 Tk FOR APRVAL   \033[1;93m▇▇
             \033[1;96m▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇
...
def reg():
    os.system('termux-setup-storage')
    os.system('clear')
    os.system('xdg-open https://www.facebook.com/profile.php?id=100087567123370')
    logo()
    print ('')
...
def bsn_menu():
    ...
    print("             [*]. FACEBOOK   : SKJIBON");time.sleep (0.03)
    print("             [*]. GITHUB     : SK JIBON");time.sleep (0.03)   
    print("             [*]. VERSION    : 2.5.6");time.sleep (0.03)
    print("             [*]. TOOL TYPE  : PAID TOOLS");time.sleep (0.03)
    print("             [*]. IP ADDRESS : [%s]\n"%(IP));time.sleep(0.01)
